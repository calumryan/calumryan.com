<article class="note note-short">
  <header class="note-header">
    <div>
        <svg class="icon" aria-hidden="true" width="20" height="20"><use xmlnsXlink="http://www.w3.org/1999/xlink" xlink:href="<?= url('assets/icons/icons.sprite.svg') ?>#icon-note"></use></svg>
    </div>
