...
<div class="intro <?php if ( $page->special()->isNotEmpty()) { echo 'h-card'; } ?>">
  ...
  <svg class="icon" aria-hidden="true" focusable="false" width="150" height="150"><use xmlnsXlink="http://www.w3.org/1999/xlink" xlink:href="<?= url('assets/icons/icons.sprite.svg#' . $page->svg()) ?>"></use></svg>
  <?php endif ?>
