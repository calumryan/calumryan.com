  ...
  <div class="page">
    ...
    <article class="band">
      ...
      <?php foreach ($articles as $article): ?>
        ...
        <img src="<?= $image->resize(150,150,100)->url() ?>" alt="" aria-hidden="true" loading="lazy" width="150" height="150">
        <?php elseif ( $article->thumbnail()->isNotEmpty() ) : ?>
        <img src="<?= $article->thumbnail() ?>" alt="" aria-hidden="true" loading="lazy" width="150" height="150">
        <?php else: ?>
