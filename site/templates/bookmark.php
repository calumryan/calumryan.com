...
<div class="book__main"><main id="content" class="page  page__center">
    ...
    <div class="note-text text note-structure h-entry">
      <div class="note-link">
        <svg aria-hidden="true" class="icon" role="img" width="50" height="50"><use xmlnsXlink="http://www.w3.org/1999/xlink" xlink:href="<?= url('assets/icons/icons.sprite.svg') ?>#icon-bookmark"></use></svg>
        <div>
